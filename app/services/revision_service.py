...
class RevisionService:
    ...
    def __init__(self) -> None:
        ...
        self.workflow_def = WorkflowRegistry().get_workflow_def("claim_revision")
    ...
    def revise_claim(
        ...
        """
        state = state or WorkflowState(raw_input="", claims_draft=claims_draft, user_feedback=user_feedback)
